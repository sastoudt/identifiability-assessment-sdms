...
save(resultsLogRegSpline, negLL, counts, value, isConverged, basisPsi, basisP, file = "single_double_visit/results/dvOccurSplineResults_smallNoSaturateLine.RData")

#### Figure 4b ####

load(file = "single_double_visit/results/dvOccurSplineResults_smallNoSaturateLine.RData")


thin <- order(zData[[1]][1:n])
jpeg("paper_figures/fig4b.jpeg", width = 824, height = 634, units = "px")
...
#### Figure 4j ####
jpeg("paper_figures/fig4j.jpeg", width = 824, height = 634, units = "px")
...
save(resultsLeleSpline, rstart, basisPsi, basisP, counts, loglik, isConverged, file = "single_double_visit/results/svOccurSplineResults_smallNoSaturateLine.RData")

#### Figure 4f ####
load(file = "single_double_visit/results/svOccurSplineResults_smallNoSaturateLine.RData")


idx <- order(zData[[1]])
jpeg("paper_figures/fig4f.jpeg", width = 824, height = 634, units = "px")
...
idx <- order(mData[[1]])
jpeg("paper_figures/fig4n.jpeg", width = 824, height = 634, units = "px")
